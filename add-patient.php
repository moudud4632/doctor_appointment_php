...
$_SESSION['active_menu']='add-patient';
$con = connection();
...
if(isset($_POST['submit']))
{
    ...
    $sql=mysqli_query($con,"insert into users(fullName, mobile_number, email, city, address, gender, age, password, role) values('$fullName', '$mobile_number', '$email', '$city', '$address', '$gender', '$age', '$password', 'patient')");
    if($sql)
    {
        echo "<script>alert('Patient Successfully created');</script>";
