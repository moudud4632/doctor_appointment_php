...
if(isset($_POST['submit']))
{
    ...
    $sql=mysqli_query($con,"insert into users(specialization, fees, fullName, mobile_number, email, city, address, gender, age, password, role) values('$specialization', '$fees', '$fullName', '$mobile_number', '$email', '$city', '$address', '$gender', '$age', '$password', 'doctor')");
    if($sql)
    {
        echo "<script>alert('Doctor Successfully Created');</script>";
                            ...
                            <div class="form-group">
                                ...
                                <select name="specialization" required="" style="width: 100%;">
                                    ...
                                    <?php while ($specialization_row=mysqli_fetch_array($specialization)){ ?>
                                        <option value="<?php echo $specialization_row['name'] ?>"><?php echo $specialization_row['name'] ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                            <div class="form-group">
                                <label>Fees <span class="text-danger">*</span></label>
                                <input type="number" name="fees" class="form-control"  value="" required="">
                            </div>
                            <div class="form-group">
