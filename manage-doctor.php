                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-hover" id="datatable">
                            ...
                            <tbody>
                            <?php
                            $sql=mysqli_query($con,"select * from users where role='doctor'");
                            $cnt=1;
                            while($row=mysqli_fetch_array($sql))
                            {
                                ...
                                <tr>
                                    ...
                                    <td class="p-0 m-0"><?php echo $row['specialization'];?></td>
                                    ...
                                    <td class="p-0 m-0">
                                        ...
                                        <a href="edit-doctor.php?id=<?php echo $row['id']?>" onClick="return confirm('Are you sure you want to edit?')" class="btn btn-primary btn-sm"><i class="fa fa-user-edit"></i></a>
                                        <a href="manage-doctor.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
